...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.tijori.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".tijori" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".tijori")
	}
